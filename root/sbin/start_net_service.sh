...
mount /dev/block/sde5 /vendor/firmware_mnt  -o gid=1000,fmask=0337,dmask=0227,codepage=437,iocharset=iso8859-1,shortname=lower
mkdir -p /mnt/vendor/persist
mount /dev/block/bootdevice/by-name/persist /mnt/vendor/persist
cp /vendor/etc/recovery_wlan/WCNSS_qcom_cfg.ini /etc/firmware/wlan/qca_cld
cp /vendor/etc/recovery_wlan/WCNSS_qcom_cfg.ini /mnt/vendor/persist/WCNSS_qcom_cfg.ini
